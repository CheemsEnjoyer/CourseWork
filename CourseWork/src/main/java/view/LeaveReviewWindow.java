...
public class LeaveReviewWindow extends javax.swing.JFrame {
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
        ...
        Users users = new Users();
        int userId = users.getUserIdByUsername(lblUsername.getText());
        CompanyController companyController = new CompanyController();
        
        int companyId = companyController.getCompanyIdByName(companyName);
        ReviewController reviewController = new ReviewController();
        reviewController.leaveReview(reviewText, rating, userId, companyId);
