...
public class ListOfCompaniesWindow extends javax.swing.JFrame {
    ...
    if (row >= 0 && col >= 0) {
        ...
        if (value != null) {
            ...
            DefaultConfig config = new DefaultConfig();
            showInformationUseCase = config.showInformationUseCase();
