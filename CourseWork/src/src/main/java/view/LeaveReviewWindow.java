...
public class LeaveReviewWindow extends javax.swing.JFrame {
    ...
    GetUserByUsernameUseCase getUserByUsernameUseCase = new GetUserByUsernameUseCase();
    Users user = getUserByUsernameUseCase.getUserByUsername(lblUsername.getText());
    int userId = user.getId();
    GetCompanyByNameUseCase getCompanyByNameUseCase = new GetCompanyByNameUseCase();
    Company company = getCompanyByNameUseCase.getCompanyByName(companyName);
    
    if (company != null) {
        int companyId = company.getId();
        LeaveReviewUseCase leaveReviewUseCase = new LeaveReviewUseCase(); 
